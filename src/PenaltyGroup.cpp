...
PenaltyGroup::PenaltyGroup(double dt, double outerEta, double innerEta, double stiffness, double CoR) : nextstep_(0), dt_(dt), outerEta_(outerEta), innerEta_(innerEta), stiffness_(stiffness), CoR_(CoR)
{	
}
